            ...
            <CardContent className="p-4 space-y-4">
              {forms.length > 1 && (
                <div className="flex items-center justify-between pb-2 border-b border-gray-700">
                  <div className="flex items-center gap-2">
                    <Label className="text-sm text-gray-400">Forms:</Label>
                    {forms.map((_, index) => (
                 ...
                 <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        <div className="flex items-center bg-white rounded-lg p-1">
                            <Input id="loan-no-search" placeholder="Search by Ln.no" value={searchQuery} onChange={(e) => { setSearchQuery(e.target.value); setIsSuggestionSelected(false); }} className="border-0 bg-transparent text-black text-sm flex-1 h-8 p-2 focus-visible:ring-0 focus-visible:ring-offset-0"/>
