...
//     { id: "mobile_no", label: "Mobile No", type: "input",  inputType: "number", value: customerData.mobile_no, required: true },
//     { id: "whatsapp_no", label: "Whatsapp No", type: "input", inputType: "number", value: customerData.whatsapp_no },
...
//                     className={`h-[50px] px-4 py-3 rounded-[30px] border border-solid focus:ring-2 focus:ring-[#fff5c5] ${
