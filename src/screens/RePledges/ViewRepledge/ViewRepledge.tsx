      ...
      <footer className="fixed bottom-0 left-0 right-0 max-w-[393px] lg:max-w-2xl mx-auto p-6 bg-white border-t border-gray-100">
        <div className="flex justify-between gap-3">
          <Button 
            ...
            className="flex-1 h-12 bg-black hover:bg-gray-800 text-white font-header-heading-semibold-heading-5-semibold rounded-full transition-colors duration-200 flex items-center justify-center gap-2"
            disabled={loading}
          >
